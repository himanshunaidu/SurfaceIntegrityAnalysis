...
from db.update import update_data_frames, sync_data_frames_with_mesh_files
...
if __name__=="__main__":
    ...
    db_results_frame = sync_data_frames_with_mesh_files(dataset_mesh_path, db_results_frame)
    update_data_frames(DATASET_PATH, db_main_frame, db_results_frame)
    
    db_main_frame, db_results_frame = load_data_frames(DATASET_PATH)
    process_mesh_files(dataset_mesh_path, db_results_frame)
    sync_data_frames_with_mesh_files(dataset_mesh_path, db_results_frame)