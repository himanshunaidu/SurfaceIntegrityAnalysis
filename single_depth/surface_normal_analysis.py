...
DATASET_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'dataset', 'ios_point_mapper'))
DATASET_CSV_PATH = os.path.join(DATASET_PATH, 'dataset_surface_integrity.csv')
DATASET_COLS = [
    'rgb_frame_path',
    'depth_frame_path',
